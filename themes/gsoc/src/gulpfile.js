...
gulp.task('sass', function() {
    return gulp.src('sass/gsoc-theme.scss')
        .pipe(sass())
        .pipe(gulp.dest('dist/css'))
        .pipe(rename('gsoc-theme.min.css'))
        .pipe(minify())
...
// gulp.task('scripts', () =>
//   gulp.src('js/gsoc-theme.js')
//     .pipe(babel())
//     .pipe(gulp.dest('dist/js'))
//     .pipe(rename('gsoc-theme.min.js'))
//     .pipe(uglify())
//     .pipe(gulp.dest('../static/dist'))
// );
...
gulp.task('javascript', function () {
  ...
  return b.bundle()
    .pipe(source('gsoc-theme.js'))
    .pipe(gulp.dest('./dist/js/'))
    .pipe(buffer())
    .pipe(rename('gsoc-theme.min.js'))

    //.pipe(source('gsoc-theme.min.js'))
...
gulp.task('default', ['sass', 'combine', 'javascript']);

gulp.task('dev', ['sass', 'combine', 'javascript', 'watch']);
